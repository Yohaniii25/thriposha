...
<?php include '../includes/functions.php' ?>
        ...
        <section id="downloads" class="service-section sec-pad centred" style="background-color: #fff;">
            <div class="auto-container">
                <div class="sec-title">
                    <p>Downloads</p>
                    <h2>Access Our Latest Documents</h2>
                </div>
                        ...
                        <div class="downloads-table">
                            ...
                            ?>
                                    <div class="download-item">
                                        <span class="document-name"><?php echo $document['title'] ?></span>
                                        <a href="../assets/thriposha_assets/tenders/<?php echo $document['category'] ?>" class="btn btn-primary" download>Download</a>
                                    </div>
