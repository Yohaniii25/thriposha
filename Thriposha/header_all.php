<header class="main-header style-one style-five">
    ...
    <div class="header-lower">
        <div class="outer-box">
            <div class="logo-box">
                <figure class="logo"><a href="index.php"><img src="../assets/thriposha_assets/images/logo/lg.png" alt=""></a></figure>
            </div>
            <div class="menu-area">
    ...
    <div class="sticky-header">
        <div class="outer-box">
            <div class="logo-box">
                <figure class="logo"><a href="index.php"><img src="../assets/thriposha_assets/images/logo/lg_3.png" alt=""></a></figure>
            </div>
            <div class="menu-area">
