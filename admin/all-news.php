                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="breadcrumb-item active">View All News</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table all-package order-list-table" id="editableTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $newsItem['news_description']; ?></td>

                                                    <!-- edit and delete options -->
                                                    <td>
                                                        <a href="edit-news.php?news_id=<?php echo $newsItem['news_id']; ?>">
                                                        <i class="fa fa-edit" title="Edit"></i>
                                                        </a>

                                                        <a href="delete-news.php?news_id=<?php echo $newsItem['news_id']; ?>" onclick="return confirm('Are you sure you want to delete this news?');">
